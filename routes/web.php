...
Route::group(['middleware' => ['role:officer']], function () {
    ...
    Route::get('/admin/todolist', 'AdminIndexController@todolist');
    Route::post('/admin/todolist/del', 'AdminIndexController@todolist_del');
    Route::post('/admin/todolist/add', 'AdminIndexController@todolist_add');
    Route::post('/admin/todolist/edit', 'AdminIndexController@todolist_edit');
